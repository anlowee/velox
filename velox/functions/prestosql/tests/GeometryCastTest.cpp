...
TEST_F(GeometryCastTest, castToVarbinary) {
  // SRID: 0 POINT (1 2)
  EXPECT_EQ(
      castFromVarbinary("000000000001000000000000000000F03F0000000000000040"),
      "POINT (1 2)");
  // SRID: 4326 POLYLINE (0 0, 10 10)
  EXPECT_EQ(
      castFromVarbinary(
          "E6100000020300000000000000000000000000000000000000000000000000244000000000000024400100000002000000000000000000000000000000000000000000000000000000000024400000000000002440"),
      "LINESTRING (0 0, 10 10)");
  // SRID: 4326 POLYLINE ((0 0, 10 10), (0 10, 10 0))
  EXPECT_EQ(
      castFromVarbinary(
          "E6100000020300000000000000000000000000000000000000000000000000244000000000000024400200000004000000000000000200000000000000000000000000000000000000000000000000244000000000000024400000000000000000000000000000244000000000000024400000000000000000"),
      "MULTILINESTRING ((0 0, 10 10), (0 10, 10 0))");
  // SRID: 3857 POLYGON ((0 0, 0 5, 5 5, 5 0, 0 0))
  EXPECT_EQ(
      castFromVarbinary(
          ""),
      "POLYGON ((0 0, 0 5, 5 5, 5 0, 0 0))");
  // SRID: 4979 POLYGON ((0 0, 0 5, 5 5, 5 0, 0 0), (1 1, 4 1, 4 4, 1 4, 1 1))
  EXPECT_EQ(
      castFromVarbinary(
          ""),
      "POLYGON ((0 0, 0 5, 5 5, 5 0, 0 0), (1 1, 4 1, 4 4, 1 4, 1 1))");
  // SRID: 4979 POLYGON ((0 0, 0 5, 5 5, 5 0, 0 0), (1 1, 1 4, 4 4, 4 1, 1 1))
  EXPECT_EQ(
      castFromVarbinary(
          ""),
      "MULTIPOLYGON (((0 0, 0 5, 5 5, 5 0, 0 0)), ((1 1, 1 4, 4 4, 4 1, 1 1)))");
  // SRID: 32633 MULTIPOINT ((1 2), (1 2))")
  EXPECT_EQ(
      castFromVarbinary(
          "000000000108000000000000000000F03F0000000000000040000000000000F03F000000000000004002000000000000000000F03F0000000000000040000000000000F03F0000000000000040"),
      "MULTIPOINT ((1 2), (1 2))");

  // Invalid cases
  VELOX_ASSERT_USER_THROW(
      castFromVarbinary("1234"), "SliceInput read exceeds buffer size.");
}
} // namespace facebook::velox::functions::prestosql
